...
class role : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:User.role) */ {
 public:
  ...
  // int32 evel = 4;
  void clear_evel();
  static const int kEvelFieldNumber = 4;
  ::google::protobuf::int32 evel() const;
  void set_evel(::google::protobuf::int32 value);
...
// int32 evel = 4;
inline void role::clear_evel() {
  evel_ = 0;
}
inline ::google::protobuf::int32 role::evel() const {
  // @@protoc_insertion_point(field_get:User.role.evel)
  return evel_;
}
inline void role::set_evel(::google::protobuf::int32 value) {
  
  evel_ = value;
  // @@protoc_insertion_point(field_set:User.role.evel)
}
